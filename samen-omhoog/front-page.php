...
<section class="workshops site-section" id="werkplaats">
	<div class="approach-inner">
		...
		<div class="work-grid">
			<div class="work-card reveal magnetic-card"><span class="work-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="2" width="6" height="11" rx="3"/><path d="M5 10a7 7 0 0 0 14 0"/><path d="M12 17v4M8 21h8"/></svg></span><strong><?php esc_html_e( 'Multimedia & podcast', 'samen-omhoog' ); ?></strong><span class="work-desc"><?php esc_html_e( 'Video, fotografie, podcast en social. Met camera, microfoon en montagesoftware vertellen jongeren hun eigen verhaal en leren ze vertellen, plannen en samenwerken.', 'samen-omhoog' ); ?></span></div>
			<div class="work-card reveal magnetic-card"><span class="work-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 3.5l6 6-2.5 2.5-6-6z"/><path d="M12 6L3.5 14.5l4 4L16 10"/></svg></span><strong><?php esc_html_e( 'Hout & metaal', 'samen-omhoog' ); ?></strong><span class="work-desc"><?php esc_html_e( 'Een echte werkplaats met handgereedschap en machines. Van ontwerp tot eindproduct: meubels maken, zagen, schuren en lassen — leren door echte opdrachten.', 'samen-omhoog' ); ?></span></div>
			<div class="work-card reveal magnetic-card"><span class="work-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M20 4L8.5 15.5M14.5 14.5L20 20M8.5 8.5L10.5 10.5"/></svg></span><strong><?php esc_html_e( 'Kapsalon', 'samen-omhoog' ); ?></strong><span class="work-desc"><?php esc_html_e( 'Knippen, verzorgen en klantcontact in een echte salonopstelling. Jongeren bouwen vakvaardigheden én sociale vaardigheden op, met aandacht en begeleiding.', 'samen-omhoog' ); ?></span></div>
			<div class="work-card reveal magnetic-card"><span class="work-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="17" r="3.5"/><circle cx="18" cy="17" r="3.5"/><path d="M6 17l4-8h5l3 8M10 9l-1-3H7"/></svg></span><strong><?php esc_html_e( '(Fat)bike-reparatie', 'samen-omhoog' ); ?></strong><span class="work-desc"><?php esc_html_e( 'Fietsen en fatbikes nakijken, onderhouden en repareren met het juiste gereedschap. Techniek, probleemoplossen en doorzetten — en een tastbaar resultaat.', 'samen-omhoog' ); ?></span></div>
			<div class="work-card reveal magnetic-card"><span class="work-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11l9-7 9 7"/><path d="M5 10v9h14v-9"/><path d="M9 19v-5h6v5"/></svg></span><strong><?php esc_html_e( 'Huiskamer & leerplek', 'samen-omhoog' ); ?></strong><span class="work-desc"><?php esc_html_e( 'Een rustige, veilige plek om te leren, huiswerk te maken, taal te oefenen en even tot rust te komen. Het hart van de inloop — hier begint vaak het contact.', 'samen-omhoog' ); ?></span></div>
		</div>
		<p class="work-note"><?php esc_html_e( 'De werkplaatsen zijn geen doel op zich, maar een middel: door echt aan de slag te gaan ontdekken jongeren hun talent, krijgen ze ritme en bouwen ze succeservaringen op.', 'samen-omhoog' ); ?></p>
	</div>
</section>
